...
#pragma pack(pop)
# 290 "C:/msys64/mingw64/include/_mingw.h" 2 3 4
# 586 "C:/msys64/mingw64/include/_mingw.h" 3 4
...
# 5 "src/pony_clib.h" 2
# 1 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/12.1.0/include/stdbool.h" 1 3 4
# 6 "src/pony_clib.h" 2
...
# 13 "src/pony_list.h" 3 4
_Bool 
# 13 "src/pony_list.h"
    ls_has_internal(void *list, size_t item_size, void *item);
size_t ls_find_internal(void *list, size_t item_size, void *item);

extern void ls_free(void *list);
# 6 "src/pony_node.h" 2

# 1 "src/pony_transform.h" 1
       

# 1 "src/pony_math.h" 1
       

# 1 "src/pony_link_features.h" 1
       
# 4 "src/pony_math.h" 2

# 1 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/12.1.0/include/tgmath.h" 1 3 4
# 32 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/12.1.0/include/tgmath.h" 3 4
# 1 "C:/msys64/mingw64/include/math.h" 1 3 4
# 10 "C:/msys64/mingw64/include/math.h" 3 4
...
# 15 "C:/msys64/mingw64/include/math.h" 3
struct _exception;
...
#pragma pack(pop)
# 33 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/12.1.0/include/tgmath.h" 2 3 4


# 1 "C:/msys64/mingw64/include/complex.h" 1 3 4
# 51 "C:/msys64/mingw64/include/complex.h" 3 4
...
# 36 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/12.1.0/include/tgmath.h" 2 3 4
# 6 "src/pony_math.h" 2
...
# 88 "src/pony_node.h"
typedef struct Node { struct NodeIntrusiveLinks alloc_info; NodeHeader *header; struct Node *parent; struct Node** children; RawTransform raw_tform; } Node ; extern NodeHeader node_header_for_Node ;
...
# 120 "src/pony_node.h" 3 4
_Bool 
# 120 "src/pony_node.h"
    node_update_transform(Node *node);
...
# 5 "src/pony_node.c"
typedef struct NodeInstrusiveLinks Link;
...
void reparent(AnyNode *child_ptr, AnyNode *new_parent_ptr) {
 ...
 if(child->parent) {
  ...
  size_t index = ({ typeof(*child->parent->children) genvar_tmp___LINE__ = (child); ls_find_internal((child->parent->children), sizeof(*(child->parent->children)), & genvar_tmp___LINE__);});
  ls_delete_internal((child->parent->children), sizeof(*(child->parent->children)), (index));

  child->parent = 
# 70 "src/pony_node.c" 3 4
                 ((void *)0)
# 70 "src/pony_node.c"
                     ;
 }
 ...
 if(new_parent) {
  do { typeof(*new_parent->children) genvar_tmp___LINE__ = (child); (new_parent->children) = ls_push_internal((new_parent->children), sizeof(*new_parent->children), & genvar_tmp___LINE__);} while(0);
 }
